...
export default function UserFilters({ onFilterChange }: UserFiltersProps) {
    ...
    return (
        <div className="bg-white/70 backdrop-blur-xl rounded-3xl border border-slate-200/60 shadow-xl shadow-slate-200/20 p-2 flex flex-wrap items-center gap-3">
            {/* Search Input */}
            ...
            <div className="relative group">
                <select
                    ...
                    className="appearance-none bg-transparent px-5 py-3.5 rounded-2xl flex items-center gap-3 hover:bg-white hover:shadow-lg hover:shadow-slate-200/30 transition-all text-[10px] font-black uppercase tracking-widest text-slate-600 focus:outline-none cursor-pointer border-none"
                >
