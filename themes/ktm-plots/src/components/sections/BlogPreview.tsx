          ...
          {posts[0] && (() => {
            ...
            return (
              <Link
                ...
                style={{ textDecoration: 'none', gridColumn: '1 / span 2', display: 'grid', gridTemplateColumns: '1fr 1fr', background: '#FFFFFF', borderRadius: '14px', overflow: 'hidden', boxShadow: '0 4px 20px rgba(0,0,0,0.08)', transition: 'transform 0.22s, box-shadow 0.22s' }}
              ...
              >
                <div style={{ position: 'relative', minHeight: '260px', background: 'linear-gradient(135deg, #1A0505 0%, #A01010 100%)' }}>
                  ...
                  <div style={{ position: 'absolute', top: '16px', left: '16px', background: '#CC1414', color: '#fff', fontSize: '0.65rem', fontWeight: 800, padding: '0.25rem 0.7rem', borderRadius: '4px', textTransform: 'uppercase', letterSpacing: '0.08em' }}>
                    Featured
                  </div>
                </div>
                <div style={{ padding: '2rem', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                  {post.categories && post.categories.length > 0 && (
                    <span style={{ fontSize: '0.68rem', fontWeight: 700, color: '#CC1414', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '0.75rem', display: 'block' }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: 'auto', paddingTop: '1rem', borderTop: '1px solid #F3F4F6' }}>
                    ...
                    <span style={{ fontSize: '0.8rem', fontWeight: 700, color: '#CC1414', display: 'flex', alignItems: 'center', gap: '0.3rem' }}>
                      Read article
                ...
                >
                  ...
                  <div style={{ padding: '0.875rem 1rem', flex: 1, display: 'flex', flexDirection: 'column' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '0.625rem', paddingTop: '0.625rem', borderTop: '1px solid #F3F4F6' }}>
                      ...
                      <span style={{ fontSize: '0.72rem', fontWeight: 700, color: '#CC1414' }}>Read →</span>
                    </div>
                  </div>
                </Link>
              );
