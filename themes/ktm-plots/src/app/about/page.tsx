...
export default async function AboutPage() {
  ...
  return (
    <>
      ...
      <section style={{ padding: '3rem 0', background: '#FFFFFF', borderTop: '1px solid #F0F0F0' }}>
        <div className="container">
          <div style={{
            display: 'flex',
            alignItems: 'center',
            ...
            borderTop: '4px solid #CC1414',
            borderRadius: '12px',
            padding: 'clamp(1.75rem, 3vw, 2.5rem) clamp(2rem, 4vw, 3rem)',
          }}>
            <div>
              <h3 style={{ fontSize: 'clamp(1.2rem, 2.5vw, 1.6rem)', fontWeight: 900, color: '#1E1E1E', marginBottom: '0.35rem' }}>
                {ctaTitle}
              </h3>
              <p style={{ color: '#6B7280', fontSize: '0.95rem', margin: 0 }}>
                Browse our available plots or get in touch for a free consultation.
              </p>
            </div>
